...
search_url = "https://www.guru.com/d/jobs/skill/html/skill/css/skill/js/"
...
budget_raw = job_listings[1].css('div.jobRecord__budget').css('span.dropdown').remove

budget = budget_raw.text.strip
